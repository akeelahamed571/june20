...
<div class="behind">
 ...
 <form class="form" action="delete" method="post">
   <h1 style="text-align:center;color:lightgreen">ADMIN ACCOUNT DELETE</h1>
   ...
   AdminName<br>
   <input type="text" name="name" id="name" value="<%=adminName%>" size=100 readonly><br><br>
   
   phone <br>
   <input type="text" name="phone" id="phone" value="<%=phone%>" size=100 readonly><br><br>
   
   user Name<br>
   <input type="text" name="userName" id="userName" value="<%=userName%>" size=100 readonly><br><br>
 
   email <br>
   <input type="email" name="email" id="email" value="<%=email%>" size=100 readonly><br><br>
   

   
   <input class="submitButton" type="submit" name="Delete" id="Delete" value="Delete profile">
