...
<form class="form" action="deletepack" method="post">
	<h1 style="text-align:center;color:lightgreen">DELETE   PACKAGE</h1>
	
	Package ID<br>
	<input type="text" name="packageID" required size=100><br>
	<pre>Please Enter Package ID of the Package that need  to be removed from the Database</pre><br><br>
	
	
	<input type="submit" value="deletePackage" name="deletePackage" class="submitButton">
