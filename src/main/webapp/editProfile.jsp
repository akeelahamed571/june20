...
<!-- END OF NAVIGATION BAR -->
   ...
   <div class="behind"> 
	...
	<%
	//get and assign values from  admin panel.jsp
  ...
  %>
   ...
   <h1 style="text-align:center;color:lightgreen">EDIT PROFILE</h1>
   
   AdminID <br/>
   <input type="text" name="adminID" value="<%=adminID %>"  size=100 readonly><br/><br/>
   
   AdminName <br/>
   <input type="text" name="name" id="name" value="<%=adminName%>" size=100><br/><br/>
   phone<br/> 
   <input type="text" name="phone" id="phone" value="<%=phone%>"size=100><br/><br/>
   user Name<br/>
   <input type="text" name="userName" id="userName" value="<%=userName%>"size=100><br/><br/>
   password<br/> 
   <input type="password" name="password " id="password" value="<%=password%>"size=100><br/><br/>
   email <br/>
   <input type="email" name="email" id="email" value="<%=email%>"size=100><br/><br/>
  
   
   <input type="submit" name="submit" id="submit" value="update profile" class="submitButton"><br/>
