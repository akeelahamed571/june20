...
<form action="pack" method="post" class="form">
<h1 style="text-align:center;color:lightgreen">UPDATE  PACKAGE</h1>

ID<br>
<input type="text" name="ID"  size=100 required  placeholder="ID"><br><br>
Package Type<br>
<input type="text" name="type" size=100 required placeholder="Type"><br><br>
Package Name<br>
<input type="text" name="name" size=100 required placeholder="Name"><br><br>
Package Price<br>
<input type="text" name="price" size=100 required placeholder="Price"><br><br>
Package Description<br>
<input type="text" name="description" size=100 required placeholder="Description"> <br><br>

<pre><input type="submit" name="submit" value="update" class="submitButton" >      <input type="reset" name="reset" value="reset" class="submitButton" ></pre>
</form>
