...
<h1 style="padding:10px; text-align:center;color:lightgreen">UPDATED PACKAGE DETAILS </h1>

package ID<br>
<input type="text" name="ID" id="ID" value="${p2.packageID}" size=100><br><br>

price<br>
<input type="text" name="ID" id="ID" value="${p2.price}"size=100><br><br>

package Type<br>
<input type="text" name="ID" id="ID" value="${p2.packageType}"size=100><br><br>

package Name<br>
<input type="text" name="ID" id="ID" value="${p2.packageName}"size=100><br><br>

description<br>
<input type="text" name="ID" id="ID" value="${p2.description}"size=100><br><br>
