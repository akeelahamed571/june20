...
<body>
  ...
  <img border="0" src="images/techtalk.jpg" alt="Pulpit rock"  width=200 height=100> 
   ...
   <button class="buttonup">register</button>
...
<!-- END OF NAVIGATION BAR -->
  ...
  <div class="behind">       
    ...
    <h1 style="padding:10px; text-align:center;color:darkgreen">Login Page</h1> 
	<form action="log" method="post"  class="form" >
	
		
	<br><br>userName <br>
		<input type="text"  name="userName" id="userName"  placeholder="userName" size="100"  required><br><br>
		
		
		password <br>
		<input type="password"  name="password" id="password"    placeholder="password" size="100"  required><br><br>
		 Remember Me<input type="checkbox"  name="remember" id="remember"   ><br><br>
		 <input  type="submit" value="login" name="submit" id="submit"  class="submitButton ">
		 
		 <a  style="margin:10px;text-decoration:none;color:lightgreen;text-align:center;" href="AdminSignup.jsp"  >don't have an account ? Sign up here!!</a><br>
